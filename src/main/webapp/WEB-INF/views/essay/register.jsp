...
$(document).ready(function() {
	...
	$("button[type='submit']").on("click", function(e) {
		...
		if($(".write_box").get(0).childNodes[0].textContent == "") {
			$(".write_box").get(0).childNodes[0].remove()
		}
		...
		<div class="container page_container">
			...
			<div class="content">
				<div class="list_wrap notice_wrap">
					<form role="form" action="/essay/register" method="post">
						...
						<input type="hidden" name="boardType" value="essay" />
					</form>
